...
public class UserManager {
    ...
    public boolean addUser(User newUser) throws ParseException {
        ...
        try
        {
            ...
            PreparedStatement pstmt = conn.prepareStatement("INSERT INTO customer(customerUsername,customerPassword,customerFirstName,customerMiddleName, customerLastName, customerAddress,customerEmail,customerTelNo) VALUES(?,?,?,?,?,?,?,?)");
